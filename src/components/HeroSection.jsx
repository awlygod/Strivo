    ...
    return (
        ...
        >
            ...
            <div className = "max-w-7xl mx-auto px-4 flex flex-col items-center text-center">
                ...
                <motion.h1 
                variants={fadeInUp}
                className = "text-5xl lg:text-8xl my-4 font-semibold tracking-tighter bg-gradient-to-b from-neutral-50 via-neutral-500 to-neutral-700 bg-clip-text text-transparent"
                >
